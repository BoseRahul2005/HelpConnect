/* ========================================
   Single User Log In Form - Script
   ======================================== */
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function handleFormSubmit(e) {
        ...
        if (formData.rememberMe) {
            localStorage.setItem('helpconnect_user_email', formData.email);
            localStorage.setItem('helpconnect_user_remember_me', 'true');
        } else {
            localStorage.removeItem('helpconnect_user_email');
            localStorage.removeItem('helpconnect_user_remember_me');
        }
    ...
    function handleGoogleSignIn(e) {
        ...
        setTimeout(() => {
            ...
            showSuccessMessage('Signing in with Google...');

            // Redirect after 2 seconds
            setTimeout(() => {
                // In real app, replace with actual Google OAuth redirect
    ...
    function loadSavedEmail() {
        const savedEmail = localStorage.getItem('helpconnect_user_email');
        const rememberMe = localStorage.getItem('helpconnect_user_remember_me');
    ...
    // Log initialization
    console.log('Single User Login form initialized');
});
